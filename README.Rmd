...
```{r echo = FALSE, out.width = 0.33, fig.align = "center"}
...
```{r fig.width = 7, fig.height = 3, warning = FALSE, message = FALSE, fig.align = "center"}
library(ggplot2)
...
The following error message will come up after running \code{daily_timeseries} or \code{hourly_timeseries} if the function is unable to pull data for a particular fips code in your `fips` vector: 
