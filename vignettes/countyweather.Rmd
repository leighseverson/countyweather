...
library(ggplot2)
ggplot(not_averaged_data, aes(x = date, y = prcp, colour = id)) + 
  geom_line() + 
  theme_minimal() 
```
...
daily_vars <- data.frame(variables = c("prcp", "snow", "snwd", "tmax", "tmin"), 
                         ...
                         most_extreme_value = c("1,100 mm", "1,600 mm", "11,500 mm", "57 degrees C", "-62 degrees C"))
library(knitr)
...
hourly_vars <- data.frame(variable = c("wind_direction", "wind_speed", 
                          ...
                          maximum = c("360", "90", "22,000 (indicates 'Unlimited')", "160,000", "61.8", 
                                      "36.8", "1,090"))
```
