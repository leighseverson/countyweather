...
## Fun `countyweather` questions (if you have extra time) 

1. How would you write a function call to pull a dataframe of daily maximum and minumum temperatures for your favorite county in Colorado, for your favorite three months of your favorite year in the 2000's? 

2. How would you edit the above function call to only include monitors with at least 75% non-missing observations? 

2. How would you find out many weather stations are contributing to that daily weather data? 

3. How would you pull up a map of where these stations are located? 

4. If you wanted to include station labels on this map, how would you do that? 

5. How would you save .rds files (with daily weather data, station metadata, and station location plots) for three of your favorite Colorado counties to your local directory? 

6. How could you repeat the above tasks for hourly temperature data? 

7. How would you remove hourly observations with quality flags indicating "Suspect" and "Erroneous"?
 
8. What's the difference between `daily_fips()` and `daily_timeseries()`? 

9. Where could you go to find out more details about the weather data, for example, if you needed details to include in a Methods section of a study using this data? 
